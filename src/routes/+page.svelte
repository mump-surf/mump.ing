<script>
    ...
    const MESHES_CT = 250; // amount of mump rain meshes
    ...
    const tick = () => {
        ...
        for (let i = 0; i < meshes.length; i++) {
            ...
            // Reset falling mump rain that are out of bounds
...
<a href="https://twitch.tv/mump">
    <video bind:this={video} src="{base}/mumping.webm"></video>
</a>
